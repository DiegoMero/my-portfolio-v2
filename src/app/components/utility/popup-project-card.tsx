    ...
    <div className="fixed z-30 top-0 left-0 p-3 w-screen h-screen flex items-center backdrop-blur-sm md:pl-24 md:pr-24" >
      <div className="bg-white p-3 rounded-lg flex flex-col gap-3 border border-[#DFE1E6] ">
        <div className="flex justify-between">
          ...
          <svg width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick}>
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          <p className="text-[#344563] md:w-3/4">{project.description}</p>
          <div className="flex flex-col md:w-1/4 md:gap-5 gap-3">
            ...
            <div className="flex gap-2 item">
              <Link href={project.liveLink} target="_blank" rel="noopener noreferrer" className="flex-1 items-center flex gap-1 border-[#6070FF] hover:bg-[#6070FF] fill-[#6070FF] hover:fill-white hover:text-white border rounded-lg p-1 text-[#396DF2] font-medium active:bg-[#2230D2] active:text-white">
              ...
              <Link href={project.sourceLink} target="_blank" rel="noopener noreferrer" className="flex-1 items-center flex gap-1 border-[#6070FF] hover:bg-[#6070FF] fill-[#6070FF] hover:fill-white hover:text-white border rounded-lg p-1 text-[#396DF2] font-medium active:bg-[#2230D2] active:text-white">
                <button className="flex items-center md:gap-2 gap-1">
                  See source

...
export default function SlideMenu({ handleClick }: { handleClick: () => void }) {
  return (
    <ul className="fixed font-semibold backdrop-blur-sm top-0 z-20 p-3 pt-[15vh] h-[100vh] w-screen text-white text-3xl flex flex-col gap-8 bg-[#6070FF]/80 animate-slide-in-menu">
      ...
      <li onClick={handleClick}><Link href="#projects">Portfolio</Link></li>
      <li onClick={handleClick}><Link href="#about">About</Link></li>
      <li onClick={handleClick}><Link href="#contact-me">Contact</Link></li>
    </ul>
  )
}